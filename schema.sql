...
-- Run this in the Supabase SQL editor before running the app.
...
CREATE TABLE IF NOT EXISTS seats (
    ...
    UNIQUE (show_id, row_num, col_num)
);

CREATE TABLE IF NOT EXISTS bookings (
    ticket_no      INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    show_id        VARCHAR(20) NOT NULL,
...
INSERT INTO shows (show_id, movie_name, show_time, total_rows, total_cols, ticket_price, poster_color) VALUES
('abc', 'Finding Nemo', '03:50 PM', 5, 8, 150, '#1f6fb2'),
('asd', 'Ice Age',      '10:00 AM', 5, 8, 150, '#2a9d8f'),
('bcd', 'Avatar',       '05:00 PM', 5, 8, 200, '#6a4c93')
ON CONFLICT (show_id) DO NOTHING;

INSERT INTO seats (show_id, row_num, col_num, is_booked)
